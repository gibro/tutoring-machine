...
class observers {
    /**
     * Callback for page_updated event
     *
     * @param \mod_page\event\course_module_updated $event The event
    ...
    /**
     * Callback for glossary_updated event
     *
     * @param \mod_glossary\event\course_module_updated $event The event
     * @return bool Success or failure
     */
     ...
     *
     * @param \mod_glossary\event\entry_created|\mod_glossary\event\entry_updated|\mod_glossary\event\entry_deleted $event The event
     * @return bool Success or failure
     */
    ...
    /**
     * Callback for h5p_updated event
     *
     * @param \mod_hvp\event\course_module_updated $event The event
     * @return bool Success or failure
     */
    ...
    /**
     * Callback for file_updated event
     *
     * @param \core\event\file_updated $event The event
     * @return bool Success or failure
     */
    ...
    /**
     * Callback for resource_updated event
     *
     * @param \mod_resource\event\course_module_updated $event The event
     * @return bool Success or failure
     */
    ...
    /**
     * Callback for course_updated event
     *
